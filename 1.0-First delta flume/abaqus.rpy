...
# Run by tpennock on Fri May 16 17:16:39 2025
#
...
leaf = dgo.LeafFromOdbNodePick(nodePick=((
    'BLOCK-2-LIN-1-8-LIN-2-1-LIN--LIN-8-1-5', 1, ('[#0 #400000 ]', )), ), )
session.viewports['Viewport: 1'].odbDisplay.displayGroup.replace(leaf=leaf)
leaf = dgo.Leaf(leafType=DEFAULT_MODEL)
session.viewports['Viewport: 1'].odbDisplay.displayGroup.replace(leaf=leaf)
session.viewports['Viewport: 1'].view.setValues(nearPlane=47.3867, 
    farPlane=83.5478, width=66.0763, height=26.0262, viewOffsetX=6.80216, 
    viewOffsetY=-0.22223)
mdb.save()
